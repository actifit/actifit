...
- [ ] **P1-1: Replace pie chart with step-progress arc ring**
...
- [ ] **P1-2: Headline "Today's Goal" progress label**
...
- [ ] **P1-3: Contextual action banner / smart nudge card**
...
- [ ] **P1-4: Condense footer navigation from 8+ items to 5**
...
- [ ] **P2-1: 7-day streak / consistency tracker strip**
...
- [ ] **P2-2: Personalized AI insight card (Gemini)**
...
- [ ] **P2-3: Improve empty gadgets state to a conversion CTA**
...
- [ ] **P2-4: Milestone celebration animations**
...
|----|-------|----------|--------|
| P1-1 | Step-progress arc ring | High | Low |
...
| P2-4 | Milestone celebration animations | Medium | Medium |
| P2-5 | Monthly activity heatmap | Medium | Medium |
| P3-1 | Reorderable dashboard cards | High | High |
| P3-2 | Health metrics chips | Medium | Medium |
| P3-3 | Community feed preview | Medium | High |
| P3-4 | Configurable step goal | High | Medium |
