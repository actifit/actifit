...
public class LeaderboardEntryAdapter extends ArrayAdapter<SinglePostModel> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_leaderboard_single_entry, parent,
                    false);
        }
        ...
        Glide.with(leaderboardContext).load(postEntry.userProfilePic).into(userProfilePic);
        ...
        detailsButton.setOnClickListener(arg0 -> {
            ...
            customTabsIntent.launchUrl(leaderboardContext,
                    Uri.parse(MainActivity.ACTIFIT_CORE_URL + postEntry.postUrl));
