...
public class BaseActivity extends AppCompatActivity {
        ...
        if (btnHelp != null) {
            btnHelp.setOnClickListener(view -> {
                ...
                if (tutVidUrl[0] != null && !tutVidUrl[0].isEmpty()) {
                    ...
                    // Toast.makeText(this, R.string.help_video_unavailable,
                    // Toast.LENGTH_SHORT).show(); // Use string resource
                }
            });
        } else {
                ...
                notificationsUrl, null, notificationsListArray -> {
                    try {
                        ...
                        if (notificationsListArray.length() > 0) {
                            // today's stats
                            todayObj = notificationsListArray.getJSONArray(1).getJSONArray(0).getJSONObject(6);// dual
                                                                                                               // array
                                                                                                               // structure
    ...
    private void renderChatData() {
        ...
        if (valueAnimator == null) {
            ...
            // valueAnimator.setFloatValues(Color.RED, Color.parseColor("#FFFFFF"),
            // Color.RED);
            valueAnimator.setFloatValues(getResources().getColor(R.color.actifitRed),
                    getResources().getColor(R.color.colorWhite));// Color.parseColor("#FFFFFF"));
            if (Utils.isDarkModeActive(this)) {
                valueAnimator.setFloatValues(getResources().getColor(R.color.colorBlack),
                        getResources().getColor(R.color.actifitRed));// Color.parseColor("#FFFFFF"));
            }

            // Add an AnimatorUpdateListener to the ValueAnimator object.
            valueAnimator.addUpdateListener(animator -> {
                // Set the background color of the TextView object to the current value of the
